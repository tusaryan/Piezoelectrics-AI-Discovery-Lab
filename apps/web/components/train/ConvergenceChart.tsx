    ...
    <div className="convergence-chart">
      ...
      {showGuide && (
        <div className="convergence-guide">
          ...
          <p><strong>Overfit:</strong> Train metric keeps improving but validation doesn&apos;t → reduce complexity.</p>
        </div>
      )}

      {/* Render one chart per target — each has its own Y-axis scale */}
      <div className="convergence-charts-grid">
        <ChartNavigator chartId="train-convergence" minHeight={180 * targets.length}>
